...
void solve()
{
    ...
    // rep(i, n)
    // {
    //     int multiTask = a[i] + b[i];
    //     if(multiTask < a[fasetestA] && multiTask < b[fasetestB] ){
    //         fasetestA = i;
    //         fasetestB = i;
    //         continue;
    //     }
    ...
    // }
    // int time = 0;
    // if (fasetestA == fasetestB)
    // {
    //     time = a[fasetestA] + b[fasetestB];
    // }
    // else
    // {
    //     time = max(a[fasetestA], b[fasetestB]);
    // }
